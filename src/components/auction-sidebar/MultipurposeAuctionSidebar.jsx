...
const MultipurposeAuctionSidebar = () => {
    ...
    useEffect(() => {
        ...
        // 5. Unconditionally exclude finished auctions
        result = result.filter(auction => {
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                                ...
                                                                <span>{auctionTimers[auction._id]?.hours || "00"}h</span>:
                                                                <span>{auctionTimers[auction._id]?.minutes || "00"}m</span>:
                                                                <span>{auctionTimers[auction._id]?.seconds || "00"}s</span>
                                                            </div>
                                                    </div>
