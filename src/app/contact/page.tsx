    ...
    return (
        <>
            ...
            <main style={{ 
                ...
                <div className="container mx-auto" style={{ maxWidth: '1440px', padding: '0 40px', position: 'relative', zIndex: 1 }}>
                    
                    {/* Page Header */}
                    <div style={{ marginBottom: '10px' }}>
                        <h1 style={{ color: primaryColor, fontSize: 'clamp(24px, 3vw, 36px)', fontWeight: '700', marginBottom: '16px', letterSpacing: '-0.5px' }}>
                            Une question ? Échangeons ensemble.
                        </h1>
                        <p style={{ color: textGrey, fontSize: '15px', maxWidth: '440px', lineHeight: '1.6', whiteSpace: 'pre-line' }}>
                    ...
                    {/* Content Section - Forced Side-by-Side with Inline Styles */}
                    <div style={{ display: 'flex', flexWrap: 'nowrap', gap: '40px', alignItems: 'flex-start', justifyContent: 'space-between' }} className="flex-mobile-stack">
                        
                        {/* Left Side - Contact Form Card */}
                        <div style={{ width: '652px', flexShrink: 0, marginTop: '30px' }}>
                            <motion.div
                                ...
                                style={{ 
                                    ...
                                    position: 'relative',
                                    overflow: 'hidden',
                                    border: '1px solid rgba(255, 255, 255, 0.3)' // Kept subtle border for distinction
                                }}
                            >
                                <form>
                                    {/* Line 1: Nom & Email */}
                        ...
                        <div style={{ width: '602px', flexShrink: 0, marginTop: '-120px' }}>
                            <motion.div
                                initial={{ opacity: 0, x: 20 }}
                                animate={{ opacity: 1, x: 0 }}
                            ...
                            >
                                <h2 style={{ color: primaryColor, fontSize: '38px', fontWeight: '700', marginBottom: '60px', letterSpacing: '-1px' }}>
                                    Restons en contact
                                </h2>

                                <div style={{ width: '439px', height: '538px', display: 'flex', flexDirection: 'column', gap: '30px' }}>
                                    {/* Address */}
                                    <div style={{ marginBottom: '60px' }}>
                                        <p style={{ color: textGrey, fontSize: '13px', fontWeight: '800', letterSpacing: '1px', marginBottom: '25px', textTransform: 'uppercase' }}>
                                            NOTRE ADRESSE
                                        </p>
                                        <div style={{ color: primaryColor, fontSize: '30px', fontWeight: '700', lineHeight: '1.2' }}>
                                    ...
                                    <div style={{ marginBottom: '60px' }}>
                                        ...
                                        <div style={{ color: primaryColor, fontSize: '30px', fontWeight: '700' }}>
                                            034 -xx-xx-xx
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div style={{ color: primaryColor, fontSize: '28px', fontWeight: '700', wordBreak: 'break-all' }}>
