...
export default function Head() {
  return (
    <>
      ...
      <link rel="icon" href="/assets/logo_mazadclick-onglet.png" type="image/png" sizes="32x32" />
      <link rel="icon" href="/assets/logo_mazadclick-onglet.png" type="image/png" sizes="192x192" />
      <link rel="shortcut icon" href="/assets/logo_mazadclick-onglet.png" type="image/png" />
      <link rel="apple-touch-icon" href="/assets/logo_mazadclick-onglet.png" sizes="180x180" />
