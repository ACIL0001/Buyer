...
export default function DirectSalesPage() {
  ...
  const COLUMNS = [
    ...
    { id: 'stock', label: 'Stock', alignRight: false, searchable: false, sortable: true },
    { id: 'ordersCount', label: 'Orders', alignRight: false, searchable: false, sortable: true },
    ...
    return (
      <TableBody>
        {data.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
          const { _id, title, category, price, stock, ordersCount, status } = row;
      ...
      {sales.length === 0 && !loading ? (
        ...
        >
          ...
          <Typography variant="body2" color="text.secondary" sx={{ maxWidth: 400 }}>
            Get started by creating your first direct sale!
          </Typography>
          <Button
            variant="contained"
            component={Link}
